...
public class ExceptionController {
  ...
  /**
   * @param exception response thrown
   * @return string constant UNPROCESSABLE_DATA, date, and exception message
   */
  @ExceptionHandler(UnprocessableData.class)
  protected ResponseEntity<ExceptionResponse> unprocessableData(UnprocessableData exception) {
    ExceptionResponse response =
            new ExceptionResponse(UNPROCESSABLE_DATA, new Date(), exception.getMessage());
